...
import com.tesis.managedbeans.mbvRectificar;
 ...
 * @author Mario Jurado
 */
@FacesConverter("profesorConverterRectificar")
public class ProfesorConverterRectificar implements Converter {
    ...
    public Object getAsObject(FacesContext fc, UIComponent uic, String value) {
        if(value != null && value.trim().length() > 0) {
            try {
                ...
                mbvRectificar profesor = (mbvRectificar) fc.getViewRoot().getViewMap().get("mbvRectificar");
