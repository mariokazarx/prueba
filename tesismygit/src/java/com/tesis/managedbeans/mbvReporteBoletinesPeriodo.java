        ...
        if (this.consultar) {
            ...
            try {
                ...
                for (Estudiante est : estudiantes) {
                    ...
                    document.add(table2);
                    // datos estudiante
                    Paragraph parEstudiante = new Paragraph(10, "Boletin Periodo" + periodo.getNumero() + " Año escolar " + cur.getAnlectivoId().getAnio()
                            + " " + cur.getNombre(), FontFactory.getFont("arial", 12, Font.NORMAL));
                    document.add(parEstudiante);
                    Paragraph parEstudiante2 = new Paragraph(10, "Estudiante: " + est.getApellido() + " " + est.getNombre(), FontFactory.getFont("arial", 12, Font.NORMAL));
