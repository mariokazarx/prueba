...
public class mbvConstanciaEstudios {
    ...
    public void imprimir(){
        ...
        try {
            ...
            /*HeaderFooter footer = new HeaderFooter(new Phrase("¡Educamos para la paz y el Progreso"
                    + "Sede Escuela Bloque 3 - Ricaurte Nariño Celular: 3218300831Emll cericaurte@hotmail.com"), true);
