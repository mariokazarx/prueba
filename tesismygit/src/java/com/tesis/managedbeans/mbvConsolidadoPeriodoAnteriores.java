...
public class mbvConsolidadoPeriodoAnteriores {
    ...
    public void imprimir() {
        ...
        try {
            ...
            Paragraph parT1 = new Paragraph("ESTUDIANTE",FontFactory.getFont("arial",8,Font.BOLD));
            ...
            for(Contenidotematico con : contenidos){
                ...
                Paragraph parT2 = new Paragraph(con.getAsignaturacicloId().getAsignaturaId().getNombre(),FontFactory.getFont("arial",8,Font.BOLD));
            ...
            Paragraph parT3 = new Paragraph("Promedio",FontFactory.getFont("arial",8,Font.BOLD));
            ...
            for(Object p:estudiantesPromedio){
                ...
                for (int i = 0; i < row.length; i++) {
                    if(row[i] instanceof Estudiante){
                        ...
                        Paragraph parC1 = new Paragraph(est.getApellido()+" "+est.getNombre(),FontFactory.getFont("arial",9,Font.NORMAL));
                        ...
                        for(Contenidotematico cont:contenidos){
                            ...
                            Paragraph parC2 = new Paragraph(getNotaEst(est,cont).toString(),FontFactory.getFont("arial",10,Font.NORMAL));
                    ...
                    if(row[i] instanceof Double){
                        ...
                        Paragraph parC3 = new Paragraph(nota.toString(),FontFactory.getFont("arial",10,Font.NORMAL));
